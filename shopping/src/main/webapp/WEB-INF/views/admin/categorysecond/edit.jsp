	...
	<div id="pageAll">
		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<form action="${pageContext.request.contextPath}/updateCategorySecond" method="post">
				<input type="hidden" name="csid" value="${categorySecond.csId }"/>
				<div class="baBody">
					<div class="bbD">
						二级分类名称：<input type="text" name="csname" class="input1" value="${categorySecond.csName }"/>
					</div>
